// src/pages/admin/EditKnowledgePage.jsx
...
const EditKnowledgePage = () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setFormData({
          ...
          category: item.category || 'Crop Cultivation',
          tags: item.tags || [],
          author: item.author || '',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await knowledgeAPI.updateItem(id, data);
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">Edit Content</h1>
        <p className="text-gray-600">Update article or video details</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="card p-6">
        <div className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              {currentThumbnail ? 'Update Thumbnail' : 'Thumbnail *'}
            </label>
          ...
          {/* Video Upload (if media type is video) */}
          {formData.mediaType === 'video' && (
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                {currentMedia ? 'Update Video' : 'Video File'}
              </label>
              ...
              {currentMedia && (
                <div className="mb-4 p-4 bg-gray-50 rounded-xl">
                  ...
                  <a 
                    href={`http://localhost:5000${currentMedia}`}
                    target="_blank"
          ...
          <div className="flex gap-4 pt-6 border-t border-gray-200">
            ...
            >
              ...
              <span>{saving ? 'Updating...' : 'Update Content'}</span>
            </button>
